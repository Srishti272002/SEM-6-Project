...
from stegano import exifHeader as aaa		#EXIF is an image format which is somewhat similar to the JPEG format.
import os
from subprocess import Popen

def encode():
	main.destroy()			#destroys main window of application
	enc=Tk()				#creates a new window for the encode function 
